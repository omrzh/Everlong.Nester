...
{
  /// <summary>
  ///   Shows a color picker dialog and returns the selected Avalonia <see cref="PColor" />.
  /// </summary>
  ...
  /// <returns>The selected Avalonia color, or <see langword="null" /> if the dialog was canceled.</returns>
